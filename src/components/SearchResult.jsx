...
function SearhResult({ error, dataImages }) {
  if (error) {
    return (
      <div className="w-10/12 max-w-screen-md px-6 py-12 mx-auto mt-12 font-mono text-xl leading-relaxed text-center text-gray-800 bg-red-700 rounded-lg shadow-sm bg-opacity-5">
